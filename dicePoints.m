...
% tjek for omslag
if diceCount(2) > 0 ; tjekOmslag = tjekOmslag + 1;
elseif bourneCount(3) > 0 ; tjekOmslag = tjekOmslag + 1;
elseif bourneCount(4) > 0 ; tjekOmslag = tjekOmslag + 1;
elseif bourneCount(6) > 0 ; tjekOmslag = tjekOmslag + 1;
end
